...
CREATE TABLE IT490_MATCH_HISTORY(
	...
	USER_ONE BIGINT NOT NULL, --steam64 id
	USER_TWO BIGINT NOT NULL, --steam64 id
	WINNER BIGINT NOT NULL, --steam64 id of winner
	MATCH_DTTM DATETIME NOT NULL,
	INSERT_DTTM DATETIME NOT NULL );

--SELECT GAME_NAME, USER_ONE, USER_TWO, WINNER, MATCH_DTTM FROM IT490_MATCH_HISTORY WHERE %s in (USER_ONE, USER_TWO) ;

--INSERT INTO IT490_MATCH_HISTORY (GAME_NAME, USER_ONE, USER_TWO, WINNER, MATCH_DTTM, INSERT_DTTM) VALUES ( %s, %s, %s, %s, %s, CURRENT_TIMESTAMP() ) ;
